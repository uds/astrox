...
(deftest zero-if-near
  (is (= 0 (math/zero-if-near 0.0001 0.001)))
  (is (= 0.0001 (math/zero-if-near 0.0001 0.00005)))
  (is (= 0.1 (math/zero-if-near 0.1 0.05)))
  (is (= 0 (math/zero-if-near 0.01 0.1)))
  (is (= 0 0 (math/zero-if-near 0.00001 0.2))))
