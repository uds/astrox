...
(defn- physics-system
  ...
  [rigid-body eid world delta-time delta-frame]
  (let [rigid-body (p/integration-step rigid-body delta-time delta-frame)
...
(defn all-systems
  "Returns a collection of 'system' functions that will be executed on each game loop tick.
   Each 'system' function handles a specific component of the entity and is defined as (fn [component eid world delta])."
  [scene]
